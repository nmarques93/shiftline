defmodule Shiftline.Coordination.CoverageRequest do
  use Ecto.Schema
  ...
  schema "coverage_requests" do
    ...
    belongs_to :selected_replacement, Shiftline.Coordination.StaffMember
    has_many :responses, Shiftline.Coordination.CoverageResponse
    has_many :activity_events, Shiftline.Coordination.ActivityEvent
