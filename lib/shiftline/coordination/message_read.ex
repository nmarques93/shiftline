defmodule Shiftline.Coordination.MessageRead do
  @moduledoc """
  Who has seen a message, and who has acknowledged it.

  Deliberately the same two-timestamp shape as `Shiftline.Coordination.CoverageResponse`:
  ...
  schema "message_reads" do
    ...
    belongs_to :message, Shiftline.Coordination.Message
