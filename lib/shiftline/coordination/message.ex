defmodule Shiftline.Coordination.Message do
  @moduledoc """
  ...
  schema "messages" do
    ...
    belongs_to :sender, Shiftline.Coordination.StaffMember
    belongs_to :recipient, Shiftline.Coordination.StaffMember

    has_many :reads, Shiftline.Coordination.MessageRead
