defmodule Shiftline.Coordination.Shift do
  @moduledoc """
  ...
  separate fact (`Shiftline.Coordination.ShiftAssignment`), because the two things
  ...
  schema "shifts" do
    ...
    has_many :assignments, Shiftline.Coordination.ShiftAssignment
