defmodule Shiftline.Translation.DeepSeek do
  ...
  Both are configurable:
      ...
      config :shiftline, Shiftline.Translation,
        adapter: Shiftline.Translation.DeepSeek,
        api_key: "...",
