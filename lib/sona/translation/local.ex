defmodule Sona.Translation.Local do
  @moduledoc """
  ...
  For genuinely dynamic translation, configure `Sona.Translation.Claude`.
  """
  ...
  def translate(text, locale) do
    translated = Gettext.with_locale(SonaWeb.Gettext, locale, fn -> gettext_lookup(text) end)
  ...
  defp gettext_lookup(text), do: Gettext.gettext(SonaWeb.Gettext, text)
end
