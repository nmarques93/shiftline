defmodule Sona.Coordination.Messages do
  @moduledoc """
  ...
  Read and acknowledgement live in `Sona.Coordination.MessageRead`, the same
  ...
  alias Sona.Coordination.{Message, MessageRead, Notifier, StaffMember}
  alias Sona.Repo
