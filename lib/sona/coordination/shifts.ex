defmodule Sona.Coordination.Shifts do
  @moduledoc """
  Shifts and who is assigned to them.

  Sona reads rotas rather than authoring them — the product sits on top of a
  ...
  Guards match `Sona.Coordination.Tasks`: writes are supervisor-only and
  ...
  alias Sona.Coordination.{Notifier, Shift, ShiftAssignment, StaffMember}
  alias Sona.Repo
