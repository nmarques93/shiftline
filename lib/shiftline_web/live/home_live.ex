defmodule ShiftlineWeb.HomeLive do
  ...
  through `Shiftline.Coordination`, which broadcasts changes back to every
  connected client.
  """
  use ShiftlineWeb, :live_view

  alias Shiftline.Coordination
  alias Shiftline.Coordination.{Events, Tasks}
  alias Shiftline.Demo
  alias ShiftlineWeb.HomeLive.{Coverage, Messages, Profile, Shifts, Today}
  ...
  def handle_event("save_settings", params, socket) do
    ...
    case Coordination.update_staff_settings(socket.assigns.current_staff.id, attrs) do
      {:ok, updated} ->
        ...
        Gettext.put_locale(ShiftlineWeb.Gettext, locale_for(updated.language))
    ...
    <div class="app-shell">
      <aside class="sidebar">
        <div class="brand-lockup">
          ...
          <div>
            <p class="brand-name">Shiftline</p>
      ...
      <main class="main-area">
        <header class="topbar">
          <div class="mobile-brand">
            <div class="brand-mark small">S</div><strong>Shiftline</strong>
          </div>
  ...
  defp refresh_data(socket) do
    ...
    Gettext.put_locale(ShiftlineWeb.Gettext, locale_for(current_staff.language))
