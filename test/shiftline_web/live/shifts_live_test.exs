defmodule ShiftlineWeb.ShiftsLiveTest do
  @moduledoc """
  ...
  alias Shiftline.Coordination.Shifts
  ...
  setup do
    ...
    %{
      ...
      mei: Repo.get_by!(Shiftline.Coordination.StaffMember, name: "Mei Tanaka")
    }
  end
  ...
  describe "creating and editing" do
    ...
    test "an end at or before the start rolls the shift into the next day", %{
      ...
      assert Shiftline.Coordination.Shift.duration_minutes(shift) == 480
    end
